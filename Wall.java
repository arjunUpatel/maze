...
public class Wall {
    ...
    public GradientPaint getLeftPaint(int n) {
        ...
        return new GradientPaint(rows[0], cols[0], new Color(r, g, b), rows[1] + 50, cols[0],
                new Color(endR, endG, endB));
    }
    ...
    public GradientPaint getRightPaint(int n) {
        ...
        return new GradientPaint(rows[0] + 50, cols[0], new Color(endR, endG, endB), rows[1] + 100, cols[0],
                new Color(r, g, b));
    }
